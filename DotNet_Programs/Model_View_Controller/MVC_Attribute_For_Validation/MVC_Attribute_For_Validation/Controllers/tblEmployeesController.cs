...
namespace MVC_Attribute_For_Validation.Controllers
{
    ...
    {
        private MydbEntities3 db = new MydbEntities3();
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,Gender,Age,HireDate,EmailAddress,Salary,PersonalWebsite")] tblEmployee tblEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,Gender,Age,HireDate,EmailAddress,Salary,PersonalWebsite")] tblEmployee tblEmployee)
        {
            if (ModelState.IsValid)
            {
